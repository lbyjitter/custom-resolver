...
-- Credit to Rxot & Sydery (helped with alot)
...
fixes = { 'Update Log: Fixed hitting players logging "unknown"', "Fixed up resolver.", "Added discord webhooking when someone loads script", "Added Watermark", "Added indicators.", "Last Updated: 9/15/24 9:43 PM" }
for i = 1, #fixes do
